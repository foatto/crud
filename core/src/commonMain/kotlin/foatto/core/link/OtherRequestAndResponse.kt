...
//--- используется в утилитах репликации (не JS), поэтому возврат mutableListOf не опасен
...
class PutReplicationRequest( val destName: String, val sourName: String, val sourDialect: String, val timeKey: Long, val alSQL: List<String> )
