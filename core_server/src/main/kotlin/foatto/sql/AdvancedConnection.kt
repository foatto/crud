...
class AdvancedConnection( dbConfig: DBConfig ) : JdbcAdvancedConnection( dbConfig ) {
    ...
    init {
        ...
        dbProperty.put( "user", dbConfig.login )
        dbProperty.put( "password", dbConfig.password )
        ...
        if( dialect == SQLDialect.H2 ) {
            ...
            dbProperty.put( "busy_timeout", "5000" )
            ...
            dbProperty.put( "synchronous", "FULL" )
            dbProperty.put( "transaction_mode", "IMMEDIATE" )
        }
