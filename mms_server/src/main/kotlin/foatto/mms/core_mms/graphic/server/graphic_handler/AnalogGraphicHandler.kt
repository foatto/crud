...
open class AnalogGraphicHandler : iGraphicHandler {
    ...
    override fun isStaticMinLimit( sca: SensorConfigA ) = sca.maxLimit > sca.minLimit
    override fun isStaticMaxLimit( sca: SensorConfigA ) = sca.maxLimit > sca.minLimit

    override fun getStaticMinLimit( sca: SensorConfigA ) = sca.minLimit
    override fun getStaticMaxLimit( sca: SensorConfigA ) = sca.maxLimit
    ...
    override fun isDynamicMinLimit( sca: SensorConfigA ) = false
    override fun isDynamicMaxLimit( sca: SensorConfigA ) = false

    override fun getDynamicMinLimit(oc: ObjectConfig, sca: SensorConfigA, rawTime: Int, rawData: Double ) = sca.minLimit
    override fun getDynamicMaxLimit(oc: ObjectConfig, sca: SensorConfigA, rawTime: Int, rawData: Double ) = sca.maxLimit
    ...
    override fun getRawData( oc: ObjectConfig, sca: SensorConfigA, bb: AdvancedByteBuffer ): Double? {
