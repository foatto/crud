...
import foatto.mms.core_mms.calc.*
...
//--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    override fun loadDynamicElements( scale: Int, objectParamData: XyStartObjectParsedData, alElement: MutableList<XyElement> ) {
        val hmZoneLimit = ZoneLimitData.getZoneLimit( stm, userConfig, hmZoneData, objectParamData.objectID,
        ...
        if( objectParamData.begTime < objectParamData.endTime ) {
            ...
            val gcd = ObjectCalc.calcGeoSensor( alRawTime, alRawData, objectConfig, objectParamData.begTime, objectParamData.endTime, scale * 16, maxEnabledOverSpeed,
