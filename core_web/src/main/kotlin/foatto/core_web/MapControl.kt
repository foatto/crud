            ...
            val newView =
                if (aView != null) {
                    ...
                    val checkedView = getXyViewCoord(
                        ...
                        aViewWidth = svgCoords.bodyWidth,
                        aViewHeight = svgCoords.bodyHeight,
            ...
            if (isMouseDown) {
                when (curMode) {
                    ...
                    MapWorkMode.ZOOM_BOX, MapWorkMode.SELECT_FOR_ACTION -> {
                        ...
                        if (mouseRect.isVisible && mouseX >= 0 && mouseX <= svgCoords.bodyWidth && mouseY >= 0 && mouseY <= svgCoords.bodyHeight) {
                            mouseRect.x2 = mouseX
                            mouseRect.y2 = mouseY
                        }
                    }
