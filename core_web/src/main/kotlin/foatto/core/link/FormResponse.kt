...
class FormCell( val cellType: FormCellType ) {
    ...
    var value = ""
    var column = 0
    val alComboString = arrayOf<String>()
    ...
    val alDateTimeField = arrayOf<Pair<String,String>>()    // name, value
    ...
    var comboName = ""
    var comboValue = 0
    val alComboData = arrayOf<Pair<Int,String>>()         // value, descr

    //--- TYPE_FILE
    var fileName = ""
    var fileID = 0
    val alFile = arrayOf<Triple<Int,String,String>>()             // id, url, text (который на самом деле просто имя файла)
    ...
    //--- значения устанавливаются извне
    val alVisible = arrayOf<Triple<String,Boolean,Array<Int>>>()  // name, state, set<value>

    //--- значения устанавливаются извне
    val alCaption = arrayOf<Triple<String,String,Array<Int>>>()  // name, string, set<value>
