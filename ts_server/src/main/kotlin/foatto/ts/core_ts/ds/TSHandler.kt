...
abstract class TSHandler : AbstractHandler() {

    companion object {

        private val CONFIG_SESSION_LOG_PATH = "ts_log_session"
        private val CONFIG_JOURNAL_LOG_PATH = "ts_log_journal"
...
//
//        stm.executeUpdate(
//            " UPDATE TS_device SET fw_version = $fwVersion , last_session_time = ${getCurrentTimeInt()} , last_session_status = '$sbStatus' , " +
...
//                " SELECT id FROM TS_day_work WHERE object_id = ${deviceConfig!!.objectID} AND ye = ${arrDT[0]} AND mo = ${arrDT[1]} AND da = ${arrDT[2]}"
//            )
//
...
//            if (!isExist)
//                stm.executeUpdate(
//                    " INSERT INTO TS_day_work ( id , user_id , object_id , ye , mo , da ) VALUES ( " +
//                        "${stm.getNextID("TS_day_work", "id")} , ${deviceConfig!!.userID} , ${deviceConfig!!.objectID} , ${arrDT[0]} , ${arrDT[1]} , ${arrDT[2]} ); "
//                )
//
...
//                //    " UPDATE TS_object SET is_auto_work_shift = 0 WHERE id = " ).append( deviceConfig.objectID ) );
